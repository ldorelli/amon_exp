...
plt.ylabel("Depth")
plt.hist2d(data[0], data[1], bins=50,  norm=LogNorm(), cmap=plt.cm.OrRd) 
plt.colorbar()
...
plt.hist(data[0], log=True, orientation='vertical',bins=30, color=['gray'])
plt.ylabel("Frequency")
plt.xlabel("Outdegree")


plt.subplot(2, 2, 3)
plt.hist(data[1], orientation='horizontal', bins=30, log=True, color=['gray'])
